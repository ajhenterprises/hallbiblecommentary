export const defaultSite = {
  ...
  disclosure: 'This commentary is part of a growing walk with the Lord. As Aaron continues to study Scripture, pray, and grow in understanding, these reflections may be clarified, expanded, or revised. Read them alongside the Bible, with Scripture as your foundation.',
  primaryLinks: [['Bible','/bible'],['Commentary','/commentary'],['Articles','/articles'],['Topics','/topics'],['People','/people'],['Series','/series'],['Sermons','/sermons']],
